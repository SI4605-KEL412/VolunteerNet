            ...
            <div class="card-body p-4">
                <form action="{{ route('manageusers.update', $user->user_id) }}" method="POST">
                    ...
                    <div class="mb-3"> <!-- Gunakan mb-3 bukan form-group -->
                        ...
                        <textarea class="form-control @error('profiledetails') is-invalid @enderror" id="profiledetails" name="profile_detail" rows="3">{{ old('profile_detail', $user->profile_detail) }}</textarea>
