...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/bookmarks/{event}', [BookmarkController::class, 'toggle'])->name('bookmarks.toggle');
    // Route untuk bookmark
    Route::post('/events/{event}/bookmark', [BookmarkController::class, 'toggle'])->name('events.bookmark');
    Route::get('/bookmarks', [BookmarkController::class, 'index'])->name('bookmarks.index');
